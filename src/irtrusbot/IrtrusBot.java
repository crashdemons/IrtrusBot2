...
public class IrtrusBot
{
    ...
    static private boolean reconnect=true;
        ...
        while(reconnect){
            ...
            while((ic=irc.readCommand())!=null && irc.isConnected()){
                ...
                if(ic.type.equals("PRIVMSG")){
                    ...
                    if(im.text.startsWith("+quit") && fromAdmin){ reconnect=false; irc.disconnect(); }
                    if(im.text.startsWith("+reconnect") && fromAdmin){ irc.sendRawLine("QUIT :reconnecting"); }
